/**
 * Seeded randomness so every ornament is reproducible journalism:
 * the same edition seed always draws the same plate.
...
/** 4x4 Bayer threshold matrix, normalized 0..1. The defining print texture. */
