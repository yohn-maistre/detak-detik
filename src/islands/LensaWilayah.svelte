<script lang="ts">
  ...
  /* ── national face: the two live counters and the macro prints ── */
...
<style>
  ...
  /* national face: two live counters + a vital-signs band */
  .ip-live { display: grid; grid-template-columns: 1fr 1px 1fr; gap: clamp(18px, 4vw, 48px); align-items: end; margin-bottom: 26px; }
